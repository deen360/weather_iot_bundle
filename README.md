...
The 'weather_iot_bundle' project was generated by using the default template.

* `src/`: Python source code for this project.
  * `src/weather_iot_bundle/`: Shared Python code that can be used by jobs and pipelines.
